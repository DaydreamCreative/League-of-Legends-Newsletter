...
Structure:
  ...
  <h3>Team by Team</h3> then, for EACH team, an <h3> subhead reading "Team (Grade)"
    where grade is a letter from A+ to F, followed by one <p> covering their best
    value pick, their biggest reach or head scratcher, the roster balance from the
    positions they drafted, and a quick verdict. Use the real player names from the
    briefing. Cover every team.
  <h3>Superlatives</h3> a short <ul>: Draft Winner, Draft Loser, Best Pick, Biggest
    Reach, Best Value, each one line with a name.
